...
const CreateAdPage = () => {
  ...
  const submitAd = async (event) => {
    ...
    for (const file of files) {
      ...
      imgList.current.push(`https://firebasestorage.googleapis.com/v0/b/awaas-vishwa-listing.appspot.com/o/ad-imgs%2F${randomFileName}?alt=media&token=7a3c9a83-a86c-4977-9d6e-093bab492265com/o/ad-imgs%2F${randomFileName}?alt=media&token=3b73f328-2cdb-43c1-9525-9f09035643ed`)
    }
      ...
      <div className="create-ad-img-container">
        {
          ...
          imagePaths.map((imgPath, index) => (
            <div className="create-ad-img" key={index}>
              <img src={imgPath} alt="" />
            </div>
          ))
        }
